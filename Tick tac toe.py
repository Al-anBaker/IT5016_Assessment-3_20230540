...
def draw_game():
    print("\n")
    print(game_board[0] + " | " + game_board[1] + " | " + game_board[2] + "     0 | 1 | 2")
    print("---------")
    print(game_board[3] + " | " + game_board[4] + " | " + game_board[5] + "     3 | 4 | 5")
    print("---------")
    print(game_board[6] + " | " + game_board[7] + " | " + game_board[8] + "     6 | 7 | 8")
    print("\n")
...
def game_loop():
    ...
    userturn = int(input("Player One: Please select a number 0 to 8: "))
    ...
    if userturn > 8 or userturn < 0:
        #if not it give this message and skips to the next players turn
        ...
        if game_board[userturn] == emty:
            ...
            #if not it prints this and skips to the next players turn
            print("Spot is Taken")
    ...
    draw_game()
    #this is Player Two's turn, userturn is a user input they can select an number between 0 and 8
    userturn = int(input("Player Two: Please select a number 0 to 8: "))
    #this sets the winning turn players number incase there is a win
    turn = 2
    #this checks if the user input is in the requred values
    if userturn > 8 or userturn < 0:
